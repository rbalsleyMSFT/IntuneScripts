...
In the **Edit rule syntax** box, use the following rule
    ...
    **Note** This filter will only find corporate enrolled Windows 10 devices. If you happened to personally enroll devices your students or employees use (via OOBE, or manually through Settings or other means) then this filter may not show all of your devices as you expect. It's best at some point in the future to reimage or re-enroll your machines so they are corporate enrolled. 
    ...
    Click **OK** in the Rule syntax box. 
...
Just like Bitlocker, Microsoft Defender Antivirus benefits from the unified security settings management where both Microsoft Defender for Endpoint and Intune will synchronize the settings from each portal. You can configure these settings in either portal. In this guide, we'll be using Intune to do so. 
...
This profile controls Tamper Protection and the Windows Defender Security Center user interface

Go to **Intune.Microsoft.com** > **Endpoint security** > **Antivirus**  
Click **Create policy**  
For **Platform** select **Windows 10, Windows 11, and Windows Server**  
For **Profile** select **Windows Security Experience** and click **Create**

|Setting (Category\Setting name)|What it does|Value
|---|---|---|
Defender\TamperProtection (Device)|Tamper protection helps protect important security features from unwanted changes and interference. This includes real-time protection, behavior monitoring, and more. Accepts signed string to turn the feature on or off. Settings are configured with an MDM solution, such as Intune and is available in Windows 10 Enterprise E5 or equivalent subscriptions.| On
...
Click **Create policy**  
For **Platform** select **Windows 10, Windows 11, and Windows Server**  
For **Profile** select **Microsoft Defender Antivirus** and click **Create**
